...
class AlgoVisualizerWidget(QWidget):
    def __init__(self):
        ...
        self.algo_combo.setToolTip("选择要演示的算法")
        self.algo_combo.setAccessibleName("算法选择")
        self.algo_combo.setAccessibleDescription("选择要可视化演示的排序或查找算法")
        ...
        self.speed_spin.setToolTip("设置动画每步之间的延迟时间")
        self.speed_spin.setAccessibleName("动画速度")
        self.speed_spin.setAccessibleDescription("设置每步动画之间的延迟毫秒数")
        self.size_spin = QSpinBox()
        self.size_spin.setRange(6, 30)
        self.size_spin.setValue(14)
        self.size_spin.setPrefix("数量 ")
        self.size_spin.setToolTip("设置数据元素的数量")
        self.size_spin.setAccessibleName("数据数量")
        self.size_spin.setAccessibleDescription("设置排序或查找的数据元素数量")
        self.run_btn = QPushButton("开始演示")
        self.run_btn.setFixedHeight(BTN_H)
        self.run_btn.setToolTip("使用随机数据开始算法演示")
        self.run_btn.setAccessibleName("开始演示")
        self.run_btn.setAccessibleDescription("使用随机数据开始算法演示动画")
        self.pause_btn = QPushButton("暂停")
        self.pause_btn.setFixedHeight(BTN_H)
        self.pause_btn.setEnabled(False)
        self.pause_btn.setToolTip("暂停或继续当前演示")
        self.pause_btn.setAccessibleName("暂停演示")
        self.pause_btn.setAccessibleDescription("暂停或继续当前算法演示")
        self.pause_btn.clicked.connect(self._toggle_pause)
        self.stop_btn = QPushButton("停止")
        self.stop_btn.setFixedHeight(BTN_H)
        self.stop_btn.setEnabled(False)
        self.stop_btn.setToolTip("停止当前演示并恢复初始状态")
        self.stop_btn.setAccessibleName("停止演示")
        self.stop_btn.setAccessibleDescription("停止当前算法演示并恢复初始状态")
        ...
        self.view.setAccessibleName("算法可视化区域")
        self.view.setAccessibleDescription("显示当前算法演示的步骤动画")
        self.desc = LocalizedTextEdit()
        self.desc.setReadOnly(True)
        self.desc.setFixedHeight(120)
        self.desc.setAccessibleName("算法说明")
        self.desc.setAccessibleDescription("当前选择算法的文字说明和适用场景")
