...
# Remove old tracks we'll rebuild
track_ids_to_rebuild = [
    "python",
    "c",
    "csharp",
    "database",
...
data["tracks"] = [t for t in data["tracks"] if t["id"] not in track_ids_to_rebuild]
...
data["tracks"].append(
    {
        ...
        "title": "Python 主线",
        "icon": "🐍",
        "summary": "从基础语法到 Web 后端开发，系统掌握 Python 工程能力。",
        "modules": [
            {
                ...
                "lessons": [
                    ...
                    },
                    {
                        "id": "py-control-flow",
                        "title": "流程控制与循环",
                        "summary": "理解 if/for/while 如何决定程序走向。",
            ...
            },
            {
                ...
                "lessons": [
                    ...
                    },
                    {
                        ...
                        "title": "推导式与函数式工具",
                        "summary": "掌握推导式和 functools/itertools 工具。",
                ...
                "lessons": [
                    {
                        "id": "py-oop-basics",
                        "title": "类、对象与继承",
                        "summary": "学习 class 定义、实例方法、继承和多态。",
                    ...
                    },
                    {
                        "id": "py-magic-methods",
                        "title": "魔术方法与描述符",
                        "summary": "理解魔术方法、property 和描述符协议。",
                    ...
                    },
                    {
                        "id": "py-typing",
                        "title": "类型注解与静态分析",
                        "summary": "学习 typing 体系（PEP 484）和静态类型检查。",
                    ...
                    },
                    {
                        ...
                        "summary": "学习 dataclass 和 PEP 8 编码规范。",
            ...
            },
            {
                ...
                "lessons": [
                    ...
                    },
                    {
                        ...
                        "title": "线程池与进程池",
                        "summary": "学习 concurrent.futures 的高级接口。",
                    ...
                    },
                    {
                        "id": "py-performance",
                        "title": "性能剖析与优化策略",
                        "summary": "学习 cProfile 定位瓶颈，理解优化策略。",
                ...
                "lessons": [
                    {
                        ...
                        "summary": "理解 HTTP 协议，用 FastAPI 快速搭建 Web 服务。",
                    ...
                    },
                    {
                        "id": "py-web-database",
                        "title": "数据库集成与 ORM",
                        "summary": "学习 SQLAlchemy 和 Alembic，掌握 ORM 操作。",
                    ...
                    },
                    {
                        ...
                        "title": "综合实战项目",
                        "summary": "从零开始设计并实现一个完整的 Python Web 项目。",
